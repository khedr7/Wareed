			...
			<div class="card">
				...
				<div class="card-body">
					<table id="example2" class="table table-bordered table-striped">
						...
						<tbody>
							<?php $i = 0; ?>
							@foreach ($user->userRating as $review)
								<?php $i++; ?>
								<tr>
									<td>
									...
									<td>
										<button type="button" data-toggle="modal" data-target="#show-review" data-user-id="{{ $user->id }}"
											data-user-name="{{ $user->name }}" data-provider-name="{{ $review->author->name }}"
